    ...
    <body>
      ...
      <div class="sidebar-menu-container" id="sidebar-menu-container">
							...
							<nav class="main-navigation pull-right hidden-xs hidden-sm">
								<ul>
									...
									<li><a href="#" class="has-submenu">Performance</a>
										<ul class="sub-menu">
											<li><a href="services.html">Best schools</a></li>
											<li><a href="clients.html">Best districts</a></li>
										</ul>
									</li>
        ...
        <div class="container" style="margin-top:211px ">    
            ...
            <?php endif; ?>
            <?php if ($this->session->flashdata('primary') == TRUE): ?>
                <div class="alert alert-success"><?php echo $this->session->flashdata('primary'); ?></div>
            <?php endif; ?>
             
            <h2> Marks Uploading Section for Students bio data</h2>
            <p> By clicking on the upload button, direct the system to the root directory of the excel file that should be uploaded.</p>
                <form method="post" action="<?php echo base_url(); ?>/index.php/studentupload/importcsv" enctype="multipart/form-data" multiple="multiple">
